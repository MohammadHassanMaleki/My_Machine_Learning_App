...
class Endpoint(models.Model):
    ...
    created_at = models.DateTimeField(_('created time'), auto_now_add=True, blank=True)
...
class MLAlgorithm(models.Model):
    ...
    owner = models.CharField(_('owner'), max_length=128)
    vreated_at = models.DateTimeField(_('created time'), auto_now_add=True, blank=True)
